...
TECH1: Modify existing src/app.js (add Clear dialog, preserve List/Detail back behavior); reuse index.html and src/styles.css; extend tests/manual.md with cancel/confirm regression.  These are planned paths, not written business code.
